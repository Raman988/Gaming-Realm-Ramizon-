...
const StatusModal = () => {
    ...
    //       if (image.camera) {
    //         return handleUploadImage(image.camera);
    //       } else if (image.url) {
    //         return image.url;
    //       } else {
    ...
    //     if(status.onEdit){
    //       dispatch(updatePost({content, images: urls, auth, status}));
    //     } else {
    //       dispatch(createPost({content, images: urls, auth, socket}));
    //     }
...
// improve these code that suits it can  upload the video such that it can use firebase
...
//                 )
//             } else {
//                 uploadTask = storage.ref(`videos/${file.name}`).put(file);
//                 uploadTask.on('state_changed',
//                     (snapshot) => {
//                         //progress
//                     },
...
//         if(status.onEdit){
//             let postRef = db.collection('posts').doc(status.editID);
//             let postData = {
//                 content,
//                 images,
//                 auth,
...
//                 setImages([])
//                 if(tracks) tracks.stop()
//                 dispatch({ type: GLOBALTYPES.STATUS, payload