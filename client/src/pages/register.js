...
const Register = () => {
    ...
    return (
        <div className="auth_page" >
            ...
            <img src={logo} alt="Logo" style={{ width: "100px", height: "100px", objectFit: "contain" ,justifyContent: 'center'}} />
                </div>
                <h3 className="text-uppercase text-center mb-4">Gaming Realm</h3>
